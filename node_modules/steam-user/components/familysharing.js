 ...
 * @returns {Promise}
 */
SteamUser.prototype.getAuthorizedBorrowers = function(options, callback) {
 ...
 * @returns {Promise}
 */
SteamUser.prototype.getAuthorizedSharingDevices = function(options, callback) {
	if (typeof options == 'function') {
		callback = options;
		options = {};
	}
 ...
 * @returns {Promise}
 */
SteamUser.prototype.authorizeLocalSharingDevice = function(deviceName, callback) {
	return StdLib.Promises.timeoutCallbackPromise(5000, null, callback, true, (resolve, reject) => {
		if (!deviceName) {
 ...
 * @param {function} [callback]
 */
SteamUser.prototype.deauthorizeSharingDevice = function(deviceToken, callback) {
	return StdLib.Promises.timeoutCallbackPromise(5000, null, callback, true, (resolve, reject) => {
 ...
 * @param {string|{deviceToken: string}} deviceToken
 */
SteamUser.prototype.activateSharingAuthorization = function(ownerSteamID, deviceToken) {
	if (!ownerSteamID){
 ...
 */
SteamUser.prototype.deactivateSharingAuthorization = function() {
	this._send(SteamUser.EMsg.ClientUseLocalDeviceAuthorizations, {
